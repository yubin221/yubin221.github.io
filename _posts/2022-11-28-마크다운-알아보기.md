---
layout: post
title:  "마크다운 알아보기 - 유레카 프로젝트 개인 GIT BLOG 과제"
author: yubin
categories: [ 개발 ]
tags: [ MARKDOWN, STUDY ]
...
> 마크다운에 관한 더 자세한 사항을 살펴보고 싶다면
> "Markdown Guide (https://www.markdownguide.org/)" 를 통하여 확인할 수 있다.

> 마크다운보다 더 다양한 기능을 활용하고 싶다면, HTML 태그를 활용하시는 것도 좋은 방법이다.
...
> 마크다운을 이해하고 사용하면서 쉽고 빠르게 스타일문서를 작성해보자.
...
* [깃허브 마크다운 Markdown 사용법](https://gist.github.com/ihoneymon/652be052a0727ad59601)
